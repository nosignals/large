...
SUB_DOMAIN=xray.gandring.my.id
...
if [[ "${#RECORD}" -le 10 ]]; then
     ...
     -H "X-Auth-Key: ${CF_KEY}" \
     -H "Content-Type: application/json" \
     --data '{"type":"A","name":"'${SUB_DO}'","content":"'${IP}'","ttl":300,"proxied":false}' | jq -r .result.id)
fi
...
if [[ "${#RECORD}" -le 10 ]]; then
     ...
     -H "X-Auth-Key: ${CF_KEY}" \
     -H "Content-Type: application/json" \
     --data '{"type":"A","name":"'${WILD}'","content":"'${IP}'","ttl":300,"proxied":false}' | jq -r .result.id)
fi
...
if [[ "${#RECORD}" -le 10 ]]; then
     ...
     -H "X-Auth-Key: ${CF_KEY}" \
     -H "Content-Type: application/json" \
     --data '{"type":"A","name":"'${SUB_PROXIED}'","content":"'${IP}'","ttl":300,"proxied":true}' | jq -r .result.id)
fi
...
RESULT=$(curl -sLX PUT "https://api.cloudflare.com/client/v4/zones/${ZONE}/dns_records/${RECORD}" \
     ...
     -H "X-Auth-Key: ${CF_KEY}" \
     -H "Content-Type: application/json" \
     --data '{"type":"A","name":"'${SUB_PROXIED}'","content":"'${IP}'","ttl":300,"proxied":true}')
...
if [[ "${#RECORD}" -le 10 ]]; then
     ...
     -H "X-Auth-Key: ${CF_KEY}" \
     -H "Content-Type: application/json" \
     --data '{"type":"A","name":"'${PROXIED}'","content":"'${IP}'","ttl":300,"proxied":false}' | jq -r .result.id)
fi
