...
echo -e "🔺️DIRECT SSH➡️$dropbearport"
echo -e "🔺️DIRECT PILOT➡️80,2095,2086,2052,443"
echo -e "🔺️OPENSSH➡️443"
echo -e "🔺️SSH SSL➡️$stunnel5port"
echo -e "🔺️SSH WS TLS➡️$ws,2096,2087,8443,2053"
echo -e "🔺️OVPN WS TLS➡️$otls,8443,2096"
echo -e "🔺️OVPN SSL➡️$ossl,8443"
echo -e "🔺️Link OVPN➡️http://$MYIP:88/"
echo -e "\033[1;31m━━━━━━━━━━━━━━━━\033[0m"
echo -e "🔺️SSH WS NONTLS➡️$ws2,8080,2095,2086,2052"
echo -e "🔺️OVPN WS NONTLS➡️$onontls,8880,2095,2086,2052"
...
echo -e "\033[1;31m━━━━━━━━━━━━━━━━\033[0m"
echo -e "🔺️PILOT SSHWS➡️ GET ws://BUGMU.COM [protocol][crlf]/HTTP/1.1[crlf]/HTTP/2[crlf]/HTTP/3[crlf]Host: $domain [crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]User-Agent: [ua][crlf][crlf]"
echo -e "\033[1;31m━━━━━━━━━━━━━━━━\033[0m"
echo -e "🔺️PILOT OVPNWS➡️ GET ws://BUGMU.COM [protocol][crlf]/HTTP/1.1[crlf]/HTTP/2[crlf]/HTTP/3[crlf]Host: $domain2 [crlf]Upgrade: Websocket[crlf]Connection: Keep-Alive[crlf]User-Agent: [ua][crlf][crlf]"
echo -e "\033[1;31m━━━━━━━━━━━━━━━━\033[0m"
echo -e "\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
