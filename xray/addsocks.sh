...
echo -e "Path WS➡️ /WISNU-WS ,/worryfree/ ,/kuota-habis/"
echo -e "Path GRPC➡️ WISNU-GRPC"
echo -e "Path TCP➡️ /COKRO-TCP"
echo -e "Path KCP➡️ COKRO-KCP"
echo -e "Path QUIC➡️ COKRO-QUIC"
echo -e "TLS➡️ ${stls},8443,2096,2087,2083,2053"
echo -e "NONTLS➡️ ${snontls},2095,2086,2082,2052"
