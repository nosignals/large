...
vlessgrpc1="vless://${uuid}@${domain}:$vlgrpc?serviceName=COKRO&sni=${domain}&mode=multi&type=grpc&security=tls&encryption=none#%F0%9F%94%A5VLESS+GRPC+TLS+${user}"
...
echo -e "TLS➡️ $vlgrpc,8443,2096,2087,2083,2053"
