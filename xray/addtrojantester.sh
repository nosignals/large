...
echo -e " 🔺️CDN HOST➡️$domain2"
echo -e "🔺️NAMA➡️${user}"
echo -e "🔺️Protokol➡️GRPC,H2C,GFW,XTLS,WS,KCP,HTTP,GO,QUIC"
#echo -e "🔺️Flow xtls➡️ only origin type not supported"
echo -e "🔺️ServiceName➡️SATRIO"
echo -e "🔺️Path HTTP➡️/GANDRING-TCP"
echo -e "🔺️Path H2C➡️/GANDRING-HTTP"
echo -e "🔺️Path WS➡️/GANDRING"
echo -e "🔺️Path QUIC➡️GANDRING-QUIC"
echo -e "🔺️Path GO➡️/gandring-go"
echo -e "🔺️Path KCP➡️GANDRING-KCP"
